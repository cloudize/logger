...
import { ProductionConsoleLogger, LoggerMessageType } from '../../../../lib';
...
describe('The Console Logger', () => {
  ...
  it('should NOT Write an Info message to the console when called', async () => {
    global.console.log = jest.fn();
  ...
  it('should NOT Write an Info message with a payload to the console when called', async () => {
    global.console.log = jest.fn();
